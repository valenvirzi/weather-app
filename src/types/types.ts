...
export type SettingKey = keyof CurrentSettings;
...
export interface PrecipitationDetailsProps extends DetailsProps {
  precipitationList: number[];
  chartWidth: number;
}

export enum ExtraWeatherDisplay {
  Humidity = "humidity",
  Precipitation = "precipitation",
  Wind = "wind",
}

export interface WeatherDisplaySelectorProps {
  extraWeatherDisplayed: ExtraWeatherDisplay;
  setExtraWeatherDisplayed: (display: ExtraWeatherDisplay) => void;
}
